...
| `design/README.md` | 业务项目设计资料目录说明模板（完整安装包含） |
| `docs/规范/可选工具协作.md` | OpenSpec、CodeGraph、Superpowers 详细流程与限制的唯一来源 |
...
3. 工具启用条件、职责、调用方式、限制和 fallback 只写入 `docs/规范/可选工具协作.md`；安装、初始化与重启说明写入 `README.md`；快速开始和场景流程只保留导航或场景特有内容。
